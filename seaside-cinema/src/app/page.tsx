    ...
    <main className="w-full">
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 text-white">
          <h1 className="text-3xl sm:text-5xl font-semibold leading-tight drop-shadow-md">
          ...
          <a
            href="/book"
            className="mt-6 inline-block bg-offwhite text-teal px-6 py-3 rounded-lg font-medium hover:bg-sand transition"
          >
      ...
      <section className="py-20 px-6 bg-peach text-center">
        <h2 className="text-2xl sm:text-4xl font-bold text-orange">An Unforgettable Experience</h2>
      ...
      >
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center text-offwhite px-6">
          <h2 className="text-3xl sm:text-5xl font-semibold drop-shadow-md">
